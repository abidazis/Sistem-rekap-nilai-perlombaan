    ...
    <div class="min-h-screen flex flex-col md:flex-row">
        ...
        <aside class="w-full md:w-64 bg-slate-900 text-white flex-shrink-0">
            ...
            <nav class="mt-6 px-4 space-y-2">
                ...
                <a href="{{ route('master.peserta') }}" wire:navigate class="block px-4 py-2 rounded transition {{ request()->routeIs('master.peserta') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-800' }}">
                    👮 Master Peserta
                </a>

                <a href="{{ route('master.juri') }}" wire:navigate class="block px-4 py-2 rounded transition {{ request()->routeIs('master.juri') ? 'bg-blue-600 text-white' : 'text-slate-300 hover:bg-slate-800' }}">
                    ⚖️ Master Juri
                </a>
